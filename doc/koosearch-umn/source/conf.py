...
otcdocs_doc_link = '/cloud-search-service/koosearch-umn/'
otcdocs_doc_title = 'Koosearch User Guide'
otcdocs_doc_type = 'koosearch-umn'
...
html_title = "Cloud Search Service - Koosearch User Guide"
...
latex_documents = [
    ('index',
     'css-koosearch-umn.tex',
    u'Cloud Search Service - Koosearch User Guide',
