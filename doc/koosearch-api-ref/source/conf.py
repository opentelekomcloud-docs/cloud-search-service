...
otcdocs_doc_link = '/cloud-search-service/koosearch-api-ref/'
otcdocs_doc_title = 'Koosearch API Reference'
otcdocs_doc_type = 'koosearch-api-ref'
...
html_title = "Cloud Search Service - Koosearch API Reference"
...
latex_documents = [
    ('index',
     'css-koosearch-api-ref.tex',
    u'Cloud Search Service - Koosearch API Reference',
