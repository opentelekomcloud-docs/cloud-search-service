...
.. table:: **Table 2** Request body parameters
   ...
   |                 |                 |                 | -  role: restarts roles.                                                                                                                                                            |
   +-----------------+-----------------+-----------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | value           | Yes             | String          | Operation parameters. Parameter description:                                                                                                                                        |
   |                 |                 |                 |                                                                                                                                                                                     |
   |                 |                 |                 | -  When the operation role is **node**, the value is the node ID. You can obtain the ID attribute in instances by referring to :ref:`Querying Cluster Details <showclusterdetail>`. |
   |                 |                 |                 |                                                                                                                                                                                     |
