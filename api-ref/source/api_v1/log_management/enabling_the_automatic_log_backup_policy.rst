...
.. table:: **Table 1** Path Parameters
   ...
   |                 |                 |                 |                                                                                                                                                                       |
   |                 |                 |                 | ID of the cluster for which automatic log backup is to be enabled. For details about how to obtain the cluster ID, see :ref:`Obtaining the Cluster ID <css_03_0101>`. |
   |                 |                 |                 |                                                                                                                                                                       |
   |                 |                 |                 | **Constraints**:                                                                                                                                                      |
   |                 |                 |                 |                                                                                                                                                                       |
   |                 |                 |                 | N/A                                                                                                                                                                   |
