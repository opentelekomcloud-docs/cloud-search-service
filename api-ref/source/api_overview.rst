...
CSS APIs comply with RESTful API design specifications. You can use the functions described in :ref:`Table 2 <css_03_0057__en-us_topic_0171174222_en-us_topic_0122640544_table27268632>` by calling the corresponding APIs.
...
.. table:: **Table 1** Description of APIs of version V2
   ...
   +------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Rolling Start <rollingrestartv2>`                                | This API is used to restart nodes one by one, which requires a long time if the nodes have a large number of indexes.                   |
   +------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Enabling Automatic Snapshot Creation <startautocreatesnapshots>` | This API is used to enable automatic snapshot creation.                                                                                 |
   +------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Disabling Automatic Snapshot Creation <stopautocreatesnapshots>` | This API is used to disable automatic snapshot creation.                                                                                |
   +------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 2** Description of APIs of version V1
   ...
   +---------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------+
   | :ref:`Snapshot Management APIs <css_03_0057__table17723165792215>`        | Create, restore, and delete snapshots. Snapshots are a convenient way to back up and restore data. |
   +---------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------+
...
.. table:: **Table 3** Cluster management APIs
   ...
   +-----------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Updating Cluster Routes <updateroute>`                                      | This API is used to update cluster routes.                                                                                                                                 |
   +-----------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Obtaining a Cluster Route <getroutes>`                                      | This API is used to obtain a cluster route.                                                                                                                                |
   +-----------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +-----------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Upgrading a Cluster Kernel <upgradecore>`                                   | This API is used to upgrade Elasticsearch from an earlier version to a later version or the same version.                                                                  |
   +-----------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Obtaining the ID of the Target Image to Upgrade To <listimages>`            | This API is used to obtain the ID of an image that the current cluster can be upgraded to.                                                                                 |
   +-----------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Obtaining Details About a Cluster Upgrade or AZ Switchover <upgradedetail>` | An upgrade may take a long time. This API can be used to check phase-by-phase information during a cluster upgrade or AZ switchover.                                       |
   +-----------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Retrying a Failed Upgrade Task <retryupgradetask>`                          | If an upgrade takes too long, there is a chance that it has already failed due to connectivity issues. You can call this API to retry the upgrade or terminate its impact. |
   +-----------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Changing the Subnet of a Cluster <changeclustersubnet>`                     | This API is used to bind a new subnet to newly added nodes after cluster creation, or in the case of a cluster subnet change.                                              |
   +-----------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Changing the AZ of a Cluster Instance <updateazbyinstancetype>`             | This API is used to change AZs by specifying node types.                                                                                                                   |
   +-----------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _css_03_0057__table197441472175:

.. table:: **Table 4** Kibana public network access APIs
...
.. table:: **Table 5** Log management APIs
   ...
   +---------------------------------------------------------------------------+------------------------------------------------------------------+
   | :ref:`Enabling an Automatic Log Backup Policy <startlogautobackuppolicy>` | This API is used to enable an automatic log backup policy.       |
   +---------------------------------------------------------------------------+------------------------------------------------------------------+
   | :ref:`Disabling an Automatic Log Backup Policy <stoplogautobackuppolicy>` | This API is used to disable an automatic log backup policy.      |
   +---------------------------------------------------------------------------+------------------------------------------------------------------+
   ...
   +---------------------------------------------------------------------------+------------------------------------------------------------------+
   | :ref:`Testing Connectivity <starttargetclusterconnectivitytest>`          | This API is used to test the connectivity between two clusters.  |
   +---------------------------------------------------------------------------+------------------------------------------------------------------+

.. _css_03_0057__table11577101272218:

.. table:: **Table 6** Public network access APIs
...
.. table:: **Table 7** Snapshot management APIs
...
.. table:: **Table 8** VPC endpoint APIs
...
.. table:: **Table 9** Parameter configuration APIs
...
.. table:: **Table 10** Load balancer APIs
