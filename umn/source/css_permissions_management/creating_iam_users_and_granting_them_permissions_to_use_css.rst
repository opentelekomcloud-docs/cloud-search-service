...
#. .. _en-us_topic_0000001938218460__li109582711173:
...
#. `Create an IAM user and add it to a user group <https://docs.otc.t-systems.com/usermanual/iam/iam_01_0031.html>`__.
   ...
   Create a user on the IAM console and add it to the user group created in :ref:`1 <en-us_topic_0000001938218460__li109582711173>`.
