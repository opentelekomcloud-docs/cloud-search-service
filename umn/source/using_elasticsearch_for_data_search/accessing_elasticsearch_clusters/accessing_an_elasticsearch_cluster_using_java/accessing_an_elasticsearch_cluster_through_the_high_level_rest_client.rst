...
Elasticsearch provides SDK (High Level REST Client) for connecting to a cluster. This client encapsulates Elasticsearch APIs. You only need to construct required structures to access the Elasticsearch cluster. For details about how to use the Rest Client, see the official document at https://www.elastic.co/guide/en/elasticsearch/client/java-rest/current/java-rest-high.html.

This section describes how to use the High Level REST Client to access a CSS cluster. The High Level REST Client can be connected to the cluster in one of the following ways:

-  :ref:`Connecting to a Non-Security Mode Cluster Through the High Level REST Client <en-us_topic_0000001972375889__en-us_topic_0000001961178813_section197550282614>`: suitable for clusters with the security mode disabled
-  :ref:`Connecting to a Security-Mode Cluster Through High Level REST Client (Without a Security Certificate) <en-us_topic_0000001972375889__en-us_topic_0000001961178813_section1523020817518>`: suitable for clusters in security mode+HTTP, and for clusters in security mode+HTTPS (without using a certificate)
-  :ref:`Connecting to a Security-Mode Cluster Through High Level REST Client (With a Security Certificate) <en-us_topic_0000001972375889__en-us_topic_0000001961178813_section1368184211106>`: suitable for clusters in security mode+HTTPS

Constraints
-----------

The High Level REST Client version should match the Elasticsearch version. For example, use High Level REST Client 7.6.2 to access an Elasticsearch 7.6.2 cluster. If your Java High Level REST Client version is later than the Elasticsearch cluster and there are incompatibility issues with a few requests, you can use **RestHighLevelClient.getLowLevelClient()** to obtain Low Level Client and customize the Elasticsearch request content.
...
.. _en-us_topic_0000001972375889__en-us_topic_0000001961178813_section197550282614:

Connecting to a Non-Security Mode Cluster Through the High Level REST Client
----------------------------------------------------------------------------

Use the High Level REST Client to connect to a non-security mode cluster and check whether the **test** index exists. The sample code is as follows:
...
.. _en-us_topic_0000001972375889__en-us_topic_0000001961178813_section1523020817518:

Connecting to a Security-Mode Cluster Through High Level REST Client (Without a Security Certificate)
-----------------------------------------------------------------------------------------------------

Connect to a security-mode cluster that uses either HTTP or HTTPS without using a security certificate.
...
.. _en-us_topic_0000001972375889__en-us_topic_0000001961178813_section1368184211106:

Connecting to a Security-Mode Cluster Through High Level REST Client (With a Security Certificate)
--------------------------------------------------------------------------------------------------

Connect to a security-mode Elasticsearch cluster that uses HTTPS using a security certificate. The sample code is as follows:

.. caution::

   For how to obtain and upload a security certificate, see :ref:`Obtaining and Uploading a Security Certificate <en-us_topic_0000001972375889__section188511124109>`.
...
.. _en-us_topic_0000001972375889__section188511124109:
