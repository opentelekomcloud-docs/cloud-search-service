...
.. warning::
   ...
   -  Use offline index building via an API only when: real-time data is not required or crucial; the cluster version is Elasticsearch 7.10.2 or later; and the cluster image version is no earlier than 7.10.2_24.3.3_x.x.x.
