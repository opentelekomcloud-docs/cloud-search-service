...
-  Terminate a task: Click **Terminate** in the **Operation** column.
   ...
   If by the time an AZ change task is terminated, the AZ has not been changed for some nodes, you can try to restore these nodes by performing :ref:`Replacing Specified Nodes for an OpenSearch Cluster <css_01_0308>`.
