:original_name: css_01_0119.html
...
-  :ref:`Standard Query <en-us_topic_0000001955726494__en-us_topic_0000001268154489_section344710865418>`: retrieves documents that are most similar to the query vector.
-  :ref:`Hybrid Query <en-us_topic_0000001955726494__en-us_topic_0000001268154489_section102341611718>`: combines vector search with traditional OpenSearch queries, such as pre-filtering and Boolean queries.
-  :ref:`Script Score Query <en-us_topic_0000001955726494__en-us_topic_0000001268154489_section4946246546>`: enables custom similarity calculations for vector searches by executing a custom script.
-  :ref:`Rescore Query <en-us_topic_0000001955726494__en-us_topic_0000001268154489_section107953451661>`: rescores and reranks the top results returned by an initial query to improve recall.
-  :ref:`Painless Syntax Extension <en-us_topic_0000001955726494__section102071126171611>`: allows the use of vector distance or similarity calculation functions in custom scripts.

.. _en-us_topic_0000001955726494__en-us_topic_0000001268154489_section344710865418:
...
.. _en-us_topic_0000001955726494__en-us_topic_0000001268154489_section102341611718:
...
-  **Pre-filtering query**
   ...
   .. table:: **Table 2** Parameters for pre-filtering query
      ...
      | Parameter       | Mandatory       | Type            | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
      +=================+=================+=================+===============================================================================================================================================================================================================================================================================================================================================================================================================================================================================================+
      | filter          | Yes             | Map             | Vector query filters. Standard OpenSearch query filters are supported, such as term and range.                                                                                                                                                                                                                                                                                                                                                                                                |
      |                 |                 |                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
.. _en-us_topic_0000001955726494__en-us_topic_0000001268154489_section4946246546:
...
.. _en-us_topic_0000001955726494__en-us_topic_0000001268154489_section107953451661:
...
.. _en-us_topic_0000001955726494__section102071126171611:
...
.. table:: **Table 6** Supported vector distance/similarity calculation functions
   ...
   |                                   |                                                                                                                                                 |
   |                                   | Only OpenSearch 1.3.6 clusters support this function.                                                                                           |
   +-----------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
   | hammings(String, DocValues)       | Hamming distance Only vectors whose **dim_type** is **binary** are supported. The input query vector must be a Base64-encoded character string. |
   |                                   |                                                                                                                                                 |
