:original_name: css_01_0321.html
...
#. Choose **Logs > Log Search**. The **Log Search** page is displayed.
   ...
   You can search records by log type, node, log level, or keyword. For a detailed description of each type of logs, see :ref:`Log Introduction <en-us_topic_0000001955726570__en-us_topic_0000001965416649_section132041636163218>`.
...
#. Enable log backup.
   ...
   a. Click **Enable Backup**. In the displayed dialog box, configure necessary settings.
      ...
      -  To enable automatic, periodic log backup, select **Automatic backup**, and set the backup policy. For more information, see :ref:`Table 2 <en-us_topic_0000001955726570__en-us_topic_0000001965416649_table13235122823218>`.
...
#. Back up logs. Two options are available: automatic or manual.
   ...
   b. In the **Modify Settings** dialog box, select **Automatic backup**, and configure the automatic backup policy.
      ...
      .. _en-us_topic_0000001955726570__en-us_topic_0000001965416649_table13235122823218:
...
#. Check the backed-up log files.
   ...
   :ref:`Table 3 <en-us_topic_0000001955726570__en-us_topic_0000001965416649_table11352134814319>` lists the log types, where **clustername** indicates the cluster name.

   .. _en-us_topic_0000001955726570__en-us_topic_0000001965416649_table11352134814319:
...
.. _en-us_topic_0000001955726570__en-us_topic_0000001965416649_section132041636163218:

Log Introduction
----------------

.. table:: **Table 4** Log introduction
...
-  **Run log description**
   ...
   .. figure:: /_static/images/en-us_image_0000002384886584.png
      :alt: **Figure 1** Run log sample

      **Figure 1** Run log sample
...
-  **Slow indexing log description**
   ...
   .. figure:: /_static/images/en-us_image_0000002385046436.png
      :alt: **Figure 2** Slow indexing log sample

      **Figure 2** Slow indexing log sample
...
-  **Slow query log description**
   ...
   .. figure:: /_static/images/en-us_image_0000002418645681.png
      :alt: **Figure 3** Slow query log sample

      **Figure 3** Slow query log sample
...
-  **Deprecation log description**
   ...
   .. figure:: /_static/images/en-us_image_0000002418565841.png
      :alt: **Figure 4** Deprecation log sample

      **Figure 4** Deprecation log sample
...
-  **Access log description**
   ...
   .. figure:: /_static/images/en-us_image_0000002384886600.png
      :alt: **Figure 5** Access log sample

      **Figure 5** Access log sample
