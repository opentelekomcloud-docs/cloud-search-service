...
.. table:: **Table 2** Data node configuration
   ...
   |                                   |                                                                                                                                                                                                                                                                                                                                                             |
   |                                   | :ref:`Node Specifications <en-us_topic_0000002319471774__en-us_topic_0000002351306217_section53901541481>` describes the application scenarios and core features of different node specifications. It can help you properly plan your cluster.                                                                                                              |
   |                                   |                                                                                                                                                                                                                                                                                                                                                             |
   ...
   |                                   |    -  The value range of node storage capacity is determined by the node flavor you select. The value must be divisible by 20. For how to calculate the required node storage capacity, see :ref:`Recommended Node Storage Capacity for Data Nodes/Cold Data Nodes <en-us_topic_0000002319471774__en-us_topic_0000002351306217_section6913184705418>`.      |
   ...
   |                                   | -  To ensure cluster availability, you should configure at least three data nodes. For how to calculate the number of nodes needed, see :ref:`Recommended Node Quantity for Data Nodes/Cold Data Nodes <en-us_topic_0000002319471774__en-us_topic_0000002351306217_section9769202175713>`.                                                                  |
   |                                   |                                                                                                                                                                                                                                                                                                                                                             |
...
.. _en-us_topic_0000002319471774__en-us_topic_0000002351306217_section53901541481:
...
.. _en-us_topic_0000002319471774__en-us_topic_0000002351306217_section6913184705418:
...
.. _en-us_topic_0000002319471774__en-us_topic_0000002351306217_section9769202175713:
...
.. table:: **Table 3** Master node configuration
   ...
   |                                   |                                                                                                                                                                                                                                                        |
   |                                   | For split-brain protection, the number of master nodes must be an odd number. For the recommended master node quantity, see :ref:`Recommended Master Node Quantity <en-us_topic_0000002319471774__en-us_topic_0000002351306217_section1156653324311>`. |
   +-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _en-us_topic_0000002319471774__en-us_topic_0000002351306217_section1156653324311:
...
.. table:: **Table 5** Client node configuration
   ...
   |                                   |                                                                                                                                                                                                      |
   |                                   | For the recommended client node quantity, see :ref:`Recommended Client Node Quantity <en-us_topic_0000002319471774__en-us_topic_0000002351306217_section479411819168>`.                              |
   +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _en-us_topic_0000002319471774__en-us_topic_0000002351306217_section479411819168:
...
.. table:: **Table 7** Cold data node configuration
   ...
   |                                   |                                                                                                                                                                                                                                                                                                                                                             |
   |                                   | For how to calculate the number of nodes needed, see :ref:`Recommended Node Quantity for Data Nodes/Cold Data Nodes <en-us_topic_0000002319471774__en-us_topic_0000002351306217_section9769202175713>`.                                                                                                                                                     |
   |                                   |                                                                                                                                                                                                                                                                                                                                                             |
