...
.. _en-us_topic_0000002353430533__en-us_topic_0000002316900222_section14999164703320:
...
When a multi-AZ cluster is created, nodes of all types are evenly distributed across different AZs. A maximum of three AZs can be used. :ref:`Table 1 <en-us_topic_0000002353430533__en-us_topic_0000002316900222_en-us_topic_0000002287671248_table539520458522>` shows the node distribution when the number of AZs varies.
...
.. _en-us_topic_0000002353430533__en-us_topic_0000002316900222_en-us_topic_0000002287671248_table539520458522:
...
In the case of a single AZ failure, if fewer than half (including half) of the nodes assuming master node responsibilities are still available, service availability will be affected. In this case, you need to restore services by referring to :ref:`Table 2 <en-us_topic_0000002353430533__en-us_topic_0000002316900222_en-us_topic_0000002287671248_table15496183015206>`.

For example, a cluster has three master nodes distributed in two AZs. If the AZ that contains one master node becomes unavailable while the other AZ remains available, services will still be available. However, if it is the other AZ, which contains two of the three master nodes, that fails, services will be interrupted, because fewer than half of the master nodes (or nodes that assume master node responsibilities) are available. In this case, restore services by referring to :ref:`Table 2 <en-us_topic_0000002353430533__en-us_topic_0000002316900222_en-us_topic_0000002287671248_table15496183015206>`.

.. _en-us_topic_0000002353430533__en-us_topic_0000002316900222_en-us_topic_0000002287671248_table15496183015206:
